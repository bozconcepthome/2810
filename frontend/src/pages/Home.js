...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-black" data-testid="home-page">
      ...
      <section className="py-24 bg-black border-t border-gray-900" data-testid="pinterest-gallery-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#C9A962]/10 rounded-full mb-4">
              <Sparkles className="w-4 h-4 text-[#C9A962]" />
              <span className="text-sm font-semibold text-[#C9A962] uppercase tracking-wide">Boz Concept Home</span>
            </div>
            <h2
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Modern ve şık tasarımlarımızla yaşam alanlarınıza ilham verin
            </p>
          </div>
          ...
          >
            {featuredProducts.map((product, index) => (
              <div
                key={product.id}
                className="break-inside-avoid group relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1C1C1C] to-[#0A0A0A] border border-gray-800 hover:border-[#C9A962] transition-all duration-300 hover:scale-[1.02] cursor-pointer"
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <Button
                      ...
                      className="bg-gradient-to-r from-[#C9A962] to-[#E6C888] hover:from-[#A78D4E] hover:to-[#C9A962] text-black font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 shadow-xl"
                    >
                ...
                {/* Product Info */}
                <div className="p-4">
                  <h3 className="text-white font-semibold text-lg mb-2 group-hover:text-[#C9A962] transition-colors line-clamp-2">
                    {product.name}
                  </h3>
                  <div className="flex items-center justify-between">
                    <span className="text-[#C9A962] font-bold text-xl">
