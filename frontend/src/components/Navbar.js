    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <Link to="/" data-testid="logo-link" className="flex items-center space-x-3 transition-all hover:scale-105 duration-300 group">
            <img
            ...
            <div className="hidden lg:block">
              <p className="text-lg font-bold bg-gradient-to-r from-[#C9A962] to-[#E6C888] bg-clip-text text-transparent" style={{ fontFamily: 'Playfair Display, serif' }}>
                Boz Concept
              </p>
              <p className="text-xs text-gray-400 -mt-1">LUXURY HOME</p>
            </div>
          </Link>
